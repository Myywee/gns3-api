...
```powershell
python build_api/topology_build.py validate build_api/lab2-starter/topology.json
python build_api/topology_build.py build build_api/lab2-starter/topology.json
python build_api/topology_build.py configure build_api/lab2-starter/topology.json
```
